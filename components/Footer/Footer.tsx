...
function Footer() {
  return (
      ...
      <div className="bg-white mx-4 lg:mx-20 px-4 relative rounded-t-3xl">
        <div className=" grid grid-cols-1 lg:grid-cols-3 pt-[10vh]  ">
          <div className="col-span-1">
            ...
            Atex Trading Limited is a newly founded company, bringing a fresh and innovative approach to the trade of raw materials and industrial machinery. Our mission is to connect high-quality suppliers with industries in need, ensuring seamless transactions and exceptional service.
            </p>
          </div>
          <div className="col-span-2 grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div className="flex flex-col items-start lg:ps-28 justify-start gap-4">
              <div className="p-4 border-b-2 w-full  border-mainYellow text-customBlue text-lg font-semibold">
                Link
              </div>
        ...
        <div className="absolute left-[10%]  top-[-90px] bg-white py-10 px-8 rounded-3xl">
          <img src="atexLogo.png" className="w-[200px] md:w-[250px]" alt="" />
        </div>
   ...
   <div className="grid grid-cols-1 md:grid-cols-2 gap-4  py-4 ">
         ...
         <div className="text-white">©2022 Company Name. All rights reserved</div>
         </div>
         <div className="text-gray-500 py-4">
         Atex International Limited
         </div>
      </div>
      </div>
    </footer>
